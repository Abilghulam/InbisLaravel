        ...
        <div class="container">
            ...
            <div class="about-content fade-in">
                <div class="about-text">
                    ...
                    <a href="javascript:void(0);" id="readMoreLink" onclick="toggleText()"><span
                            class="pointer">...</span> more</a>
                </div>

                <iframe class="about-video" width="560" height="315"
                    src="https://www.youtube.com/embed/6020shHfBX4?si=QM_lf_4FXJgo39uv" title="YouTube video player"
                    frameborder="0"
        ...
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="store-card">
                    ...
                    <div class="overlay">
                        <h3>AB Computer</h3>
                        <button class="btn-see" data-store="AB Computer"
                ...
                <div class="store-card">
                    ...
                    <div class="overlay">
                        <h3>Arfa Computer</h3>
                        <button class="btn-see" data-store="Arfa Computer"
                ...
                <div class="store-card">
                    ...
                    <div class="overlay">
                        <h3>Hana Computer</h3>
                        <button class="btn-see" data-store="Hana Computer"
                ...
                <div class="store-card">
                    ...
                    <div class="overlay">
                        ...
                        <button class="btn-see" data-store="Gustika Computer"
                ...
                <div class="store-card">
                    ...
                    <div class="overlay">
                        ...
                        <button class="btn-see" data-store="Assio Computer"
                ...
                <div class="store-card">
                    ...
                    <div class="overlay">
                        ...
                        <button class="btn-see" data-store="Azhar Computer"
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Ari+Sandi&background=dc2626&color=fff&size=60"
                            alt="Profile Photo 1" />
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Orvalla+Savarannie&background=f97316&color=fff&size=60"
                            alt="Profile Photo 2" />
                        <div class="review-info">
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Satria+Cassanova&background=ca8a04&color=fff&size=60"
                            alt="Profile Photo 3" />
                        <div class="review-info">
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Djorgi+Fadilla&background=16a34a&color=fff&size=60"
                            alt="Profile Photo 4" />
                        <div class="review-info">
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Mario+Balu&background=0d9488&color=fff&size=60"
                            alt="Profile Photo 5" />
                        <div class="review-info">
                            <h4>Mario Bulu</h4>
                            <div class="review-meta">
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Putri+Sabela&background=2563eb&color=fff&size=60"
                            alt="Profile Photo 6" />
                        <div class="review-info">
                            <h4>Putri Sabela</h4>
                            <div class="review-meta">
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Ayuma+Dini&background=7c3aed&color=fff&size=60"
                            alt="Profile Photo 7" />
                        <div class="review-info">
                            <h4>Ayuma Dini</h4>
                            <div class="review-meta">
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Satrio+Bagas&background=be185d&color=fff&size=60"
                            alt="Profile Photo 8" />
                        <div class="review-info">
                            <h4>Satrio Bagas</h4>
                            <div class="review-meta">
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Dyah+Kusumawati&background=db2777&color=fff&size=60"
                            alt="Profile Photo 9" />
                        <div class="review-info">
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Wenny+Wahyu&background=6d28d9&color=fff&size=60"
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Manis+Tasya&background=4b5563&color=fff&size=60"
                ...
                <div class="swiper-slide review-card">
                    <div class="review-header">
                        <img src="https://ui-avatars.com/api/?name=Claudya+Cindy&background=b91c1c&color=fff&size=60"
    ...
    <section class="section business-partner" id="business-partner">
        <div class="container">
            ...
            <div class="business-partner-grid fade-in">
                ...
                <div class="business-partner-card">
                    <div class="logo-wrapper">
                        <img src="img/partner/biz-removebg-preview.png" alt="PT. BIZ Ponsel" />
                    </div>
                    <p>BIZ Ponsel</p>
                </div>
